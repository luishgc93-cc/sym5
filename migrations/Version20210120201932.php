 ...
 */
final class Version20210120201932 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE adjunto (id INT AUTO_INCREMENT NOT NULL, task_id INT NOT NULL, ficheros VARCHAR(255) DEFAULT NULL, INDEX IDX_78BCCC308DB60186 (task_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
